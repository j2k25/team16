    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form:
        ...
        if account:
            ...
            if session['is_manager'] == 1:
                ...
                return render_template('manager_home.html', msg=msg)
            else:
                if session['is_manager'] == 0:
                    # Redirect to employee home page
                    return render_template('employee_home.html', msg=msg)
        else:
...
# http://localhost:5000/pythinlogin/insert - this will be the registration page, we need to use both GET and POST requests
